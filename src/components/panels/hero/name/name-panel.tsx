					...
					<Popover
						content={
							<Space orientation='vertical'>
								...
								<Button block={true} type='text' onClick={() => props.onShowState(HeroModalType.Settings)}>Settings</Button>
							</Space>
						}
					>
						<Button>Tools</Button>
									...
									<Popover
										...
										content={
											<Space orientation='vertical' style={{ width: '150px' }}>
												...
												<Button type='text' block={true} onClick={() => { props.onShowState(HeroModalType.Settings); setOpen(false); }}>Settings</Button>
											</Space>
										}
										open={open}
